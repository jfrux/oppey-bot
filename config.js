const config = {
  ...
  // DO NOT HARD CODE THIS OR ACCIDENTALLY COMMIT A KEY TO GITHUB.
  // GENERATE A NEW KEY IN YOUR OWN PERSONAL DISCORD DEVELOPER CONSOLE AND USE THAT TO TEST OPPEY BOT CHANGES.
  ...
  permLevels: [
    ...
    { level: 2,
      ...
      name: "Moderator",
      // The following lines check the server the message came from for the roles.
    ...
    { level: 4,
      name: "Server Owner", 
      // Simple check, if the server owner id matches the message author's ID, then it will return true.
